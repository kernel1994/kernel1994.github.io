...
function MultipleUnderline(element, underlineStyles, elementStyles) {
    ...
    if (this.underlineStyles['text-underline-width'] == "auto") {
        ...
        if (this.dotWidth / 6 <= 2="" 2)="" {="" this.strokewidth="Math.round(this.dotWidth" 3)="" 2;="" }="" else="" 6);="" if="" set="" to="" px="" value="" get="" number="" determine="" the="" text-underline-position="" underlineposition="" in="" ratio="" this.underlineposition="parseFloat(this.elementStyles.fontSize)" *="" 0.89;="" (this.strokewidth="" <="1" ||="" %="" &&=""> 2)) {
